...
{ 
	...
	public class AdvancedListBaseAutomationImpl extends ScrollControlBaseAutomationImpl 
	{
		...
		override public function get numAutomationChildren():int
		{
			...
			// now we traverse in the list from the end till we are done
			// with the empty cells. (i.e we need to remove the empty element count
		...
		protected function dragStartHandler(event:DragEvent):void
		{
			...
			// air gets the drag start event twice. we need to record only once
			// so we are doing it based on the dragSource
