...
public class DataGridEvent extends Event
{
    ...
    */
     ...
     *  <code>type</code> property of the event object for a
     *  <code>itemEditorCreate</code> event, which indicates that the datagrid has
     *  completed the creation of the item editor.
     *
     *  <p>There is no default listener for this event.</p>
     *
     *  <p>You typically write your own event listener for this event to allow
     *  custom modifications to the <code>itemEditor</code> before the user can
     *  begin editing.</p>
     *
     *  <p>The properties of the event object have the following values:</p>
     *  <table class="innertable">
     ...
     *       Use the <code>currentTarget</code> property to always access the
     *       Object listening for the event.</td></tr>
     *     <tr><td><code>type</code></td><td>DataGridEvent.ITEM_EDITOR_CREATE</td></tr>
     *  </table>
     *
     *  @eventType itemEditorCreate
     */
