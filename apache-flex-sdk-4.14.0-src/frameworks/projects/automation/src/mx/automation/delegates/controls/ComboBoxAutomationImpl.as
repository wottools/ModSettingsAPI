...
package mx.automation.delegates.controls 
{
	...
	public class ComboBoxAutomationImpl extends ComboBaseAutomationImpl
	{
		...
		override public function createAutomationIDPartWithRequiredProperties(child:IAutomationObject, properties:Array):Object
		{
			...
			/*
			var delegateObj:Object = delegate as Object;
			if(delegateObj &&(delegateObj.hasOwnProperty("createAutomationIDPartWithRequiredProperties")))
				return  delegateObj.createAutomationIDPartWithRequiredProperties(child,properties);
			if(delegate && delegate.automationDelegate &&(delegate.automationDelegate.hasOwnProperty("createAutomationIDPartWithRequiredProperties")))
				return  delegate.automationDelegate.createAutomationIDPartWithRequiredProperties(child,properties);
			*/
		...
		override protected function setupEditHandler():void
		{
			...
			var text:DisplayObject = comboBase.getTextInput()  as DisplayObject;
			if (!text)
				return;
		...
		{
			var textInput:DisplayObject = comboBox.getTextInput() as DisplayObject;
