	...
	public class TextLayoutFormat implements ITextLayoutFormat
	{
		...
		static public function get columnBreakBeforeProperty():Property
		{
			if (!_columnBreakBeforeProperty)
				_columnBreakBeforeProperty = Property.NewEnumStringProperty(
				"columnBreakBefore",BreakStyle.AUTO,false,Vector.<String>([Category.PARAGRAPH])
				,BreakStyle.AUTO
				,BreakStyle.ALWAYS
				);
		...
		static public function get columnBreakAfterProperty():Property
		{
			if (!_columnBreakAfterProperty)
				_columnBreakAfterProperty = Property.NewEnumStringProperty(
				"columnBreakAfter",BreakStyle.AUTO,false,Vector.<String>([Category.PARAGRAPH])
				,BreakStyle.AUTO
				,BreakStyle.ALWAYS
				);
		...
		static public function get containerBreakBeforeProperty():Property
		{
			if (!_containerBreakBeforeProperty)
				_containerBreakBeforeProperty = Property.NewEnumStringProperty(
				"containerBreakBefore",BreakStyle.AUTO,false,Vector.<String>([Category.PARAGRAPH])
				,BreakStyle.AUTO
				,BreakStyle.ALWAYS
				);
		...
		static public function get containerBreakAfterProperty():Property
		{
			if (!_containerBreakAfterProperty)
				_containerBreakAfterProperty = Property.NewEnumStringProperty(
				"containerBreakAfter",BreakStyle.AUTO,false,Vector.<String>([Category.PARAGRAPH])
				,BreakStyle.AUTO
				,BreakStyle.ALWAYS
				);
		...
		{
			if (!_colorProperty)
			_colorProperty = Property.NewUintOrEnumProperty(
				"color",0,true,Vector.<String>([Category.CHARACTER])
				,ColorName.BLACK
				,ColorName.GREEN
				,ColorName.GRAY
				,ColorName.BLUE
		...
		static public function get backgroundColorProperty():Property
		{
			...
			_backgroundColorProperty = Property.NewUintOrEnumProperty(
				"backgroundColor",BackgroundColor.TRANSPARENT,false,Vector.<String>([Category.CHARACTER,Category.PARAGRAPH,Category.CONTAINER,Category.TABLE,Category.TABLEROW,Category.TABLECOLUMN,Category.TABLECELL])
		...
		static public function get baselineShiftProperty():Property
		{
			...
			_baselineShiftProperty = Property.NewNumberOrPercentOrEnumProperty("baselineShift",0.0,true,Vector.<String>([Category.CHARACTER]),-1000,1000,"-1000%","1000%"
		...
		static public function get breakOpportunityProperty():Property
		{
			if (!_breakOpportunityProperty)
				_breakOpportunityProperty = Property.NewEnumStringProperty(
		...
		static public function get digitCaseProperty():Property
		{
			if (!_digitCaseProperty)
				_digitCaseProperty = Property.NewEnumStringProperty(
		...
		static public function get digitWidthProperty():Property
		{
			if (!_digitWidthProperty)
				_digitWidthProperty = Property.NewEnumStringProperty(
		...
		static public function get dominantBaselineProperty():Property
		{
			if (!_dominantBaselineProperty)
				_dominantBaselineProperty = Property.NewEnumStringProperty(
		...
		{
			if (!_kerningProperty)
				_kerningProperty = Property.NewEnumStringProperty(
		...
		static public function get ligatureLevelProperty():Property
		{
			if (!_ligatureLevelProperty)
				_ligatureLevelProperty = Property.NewEnumStringProperty(
		...
		static public function get alignmentBaselineProperty():Property
		{
			if (!_alignmentBaselineProperty)
				_alignmentBaselineProperty = Property.NewEnumStringProperty(
		...
		static public function get typographicCaseProperty():Property
		{
			if (!_typographicCaseProperty)
				_typographicCaseProperty = Property.NewEnumStringProperty(
		...
		static public function get textDecorationProperty():Property
		{
			if (!_textDecorationProperty)
				_textDecorationProperty = Property.NewEnumStringProperty(
		...
		static public function get fontWeightProperty():Property
		{
			if (!_fontWeightProperty)
				_fontWeightProperty = Property.NewEnumStringProperty(
		...
		static public function get fontStyleProperty():Property
		{
			if (!_fontStyleProperty)
				_fontStyleProperty = Property.NewEnumStringProperty(
		...
		static public function get whiteSpaceCollapseProperty():Property
		{
			if (!_whiteSpaceCollapseProperty)
				_whiteSpaceCollapseProperty = Property.NewEnumStringProperty(
		...
		static public function get renderingModeProperty():Property
		{
			if (!_renderingModeProperty)
				_renderingModeProperty = Property.NewEnumStringProperty(
		...
		static public function get cffHintingProperty():Property
		{
			if (!_cffHintingProperty)
				_cffHintingProperty = Property.NewEnumStringProperty(
		...
		static public function get fontLookupProperty():Property
		{
			if (!_fontLookupProperty)
				_fontLookupProperty = Property.NewEnumStringProperty(
		...
		static public function get textRotationProperty():Property
		{
			if (!_textRotationProperty)
				_textRotationProperty = Property.NewEnumStringProperty(
		...
		static public function get textAlignProperty():Property
		{
			if (!_textAlignProperty)
				_textAlignProperty = Property.NewEnumStringProperty(
				"textAlign",TextAlign.START,true,Vector.<String>([Category.PARAGRAPH,Category.TABLE,Category.TABLECELL,Category.TABLEROW,Category.TABLECOLUMN])
				,TextAlign.LEFT
				,TextAlign.RIGHT
				,TextAlign.CENTER
				,TextAlign.JUSTIFY
		...
		static public function get textAlignLastProperty():Property
		{
			if (!_textAlignLastProperty)
				_textAlignLastProperty = Property.NewEnumStringProperty(
		...
		static public function get textJustifyProperty():Property
		{
			if (!_textJustifyProperty)
				_textJustifyProperty = Property.NewEnumStringProperty(
		...
		static public function get justificationRuleProperty():Property
		{
			if (!_justificationRuleProperty)
				_justificationRuleProperty = Property.NewEnumStringProperty(
		...
		static public function get justificationStyleProperty():Property
		{
			if (!_justificationStyleProperty)
				_justificationStyleProperty = Property.NewEnumStringProperty(
		...
		static public function get directionProperty():Property
		{
			if (!_directionProperty)
				_directionProperty = Property.NewEnumStringProperty(
				"direction",Direction.LTR,true,Vector.<String>([Category.PARAGRAPH,Category.TABLE,Category.TABLECELL,Category.TABLEROW,Category.TABLECOLUMN])
				,Direction.LTR
				,Direction.RTL
				);
		...
		static public function get leadingModelProperty():Property
		{
			if (!_leadingModelProperty)
				_leadingModelProperty = Property.NewEnumStringProperty(
		...
		static public function get paddingLeftProperty():Property
		{
			...
			_paddingLeftProperty = Property.NewNumberOrEnumProperty(
		...
		static public function get paddingTopProperty():Property
		{
			...
			_paddingTopProperty = Property.NewNumberOrEnumProperty(
		...
		static public function get paddingRightProperty():Property
		{
			...
			_paddingRightProperty = Property.NewNumberOrEnumProperty(
		...
		static public function get paddingBottomProperty():Property
		{
			...
			_paddingBottomProperty = Property.NewNumberOrEnumProperty(
		...
		static public function get columnCountProperty():Property
		{
			...
			_columnCountProperty = Property.NewIntOrEnumProperty(
		...
		static public function get columnWidthProperty():Property
		{
			...
			_columnWidthProperty = Property.NewNumberOrEnumProperty(
		...
		static public function get firstBaselineOffsetProperty():Property
		{
			...
			_firstBaselineOffsetProperty = Property.NewNumberOrEnumProperty(
		...
		static public function get verticalAlignProperty():Property
		{
			if (!_verticalAlignProperty)
				_verticalAlignProperty = Property.NewEnumStringProperty(
				"verticalAlign",VerticalAlign.TOP,false,Vector.<String>([Category.CONTAINER,Category.TABLECELL,Category.TABLE,Category.TABLEROW,Category.TABLECOLUMN])
				,VerticalAlign.TOP
		...
		static public function get blockProgressionProperty():Property
		{
			if (!_blockProgressionProperty)
				_blockProgressionProperty = Property.NewEnumStringProperty(
		...
		static public function get lineBreakProperty():Property
		{
			if (!_lineBreakProperty)
				_lineBreakProperty = Property.NewEnumStringProperty(
				"lineBreak",LineBreak.TO_FIT,false,Vector.<String>([Category.CONTAINER,Category.TABLECELL])
				,LineBreak.EXPLICIT
				,LineBreak.TO_FIT
				);
		...
		static public function get listStyleTypeProperty():Property
		{
			if (!_listStyleTypeProperty)
				_listStyleTypeProperty = Property.NewEnumStringProperty(
		...
		static public function get listStylePositionProperty():Property
		{
			if (!_listStylePositionProperty)
				_listStylePositionProperty = Property.NewEnumStringProperty(
		...
		static public function get clearFloatsProperty():Property
		{
			if (!_clearFloatsProperty)
				_clearFloatsProperty = Property.NewEnumStringProperty(
		...
		static public function get borderLeftColorProperty():Property
		{
			...
			_borderLeftColorProperty = Property.NewUintOrEnumProperty(
				"borderLeftColor",BorderColor.TRANSPARENT,false,Vector.<String>([Category.CONTAINER,Category.PARAGRAPH])
		...
		static public function get borderRightColorProperty():Property
		{
			...
			_borderRightColorProperty = Property.NewUintOrEnumProperty(
				"borderRightColor",BorderColor.TRANSPARENT,false,Vector.<String>([Category.CONTAINER,Category.PARAGRAPH])
				,BorderColor.TRANSPARENT
			);
		...
		static public function get borderTopColorProperty():Property
		{
			...
			_borderTopColorProperty = Property.NewUintOrEnumProperty(
				"borderTopColor",BorderColor.TRANSPARENT,false,Vector.<String>([Category.CONTAINER,Category.PARAGRAPH])
				,BorderColor.TRANSPARENT
			);
		...
		static public function get borderBottomColorProperty():Property
		{
			...
			_borderBottomColorProperty = Property.NewUintOrEnumProperty(
				"borderBottomColor",BorderColor.TRANSPARENT,false,Vector.<String>([Category.CONTAINER,Category.PARAGRAPH])
				,BorderColor.TRANSPARENT
			);
		...
		{
			if (!_frameProperty)
				_frameProperty = Property.NewEnumStringProperty(
				"frame",TableFrame.VOID,false,Vector.<String>([Category.TABLE])
				,TableFrame.VOID
				,TableFrame.ABOVE
				,TableFrame.BELOW
				,TableFrame.HSIDES
		...
		{
			if (!_rulesProperty)
				_rulesProperty = Property.NewEnumStringProperty(
				"rules",TableRules.NONE,false,Vector.<String>([Category.TABLE])
				,TableRules.NONE
				,TableRules.GROUPS
				,TableRules.ROWS
				,TableRules.COLS
		 ...
		 * @playerversion AIR 1.5
		 * @langversion 3.0
		 * @see flashx.textLayout.formats.BreakStyle
		 */
		 ...
		 * @playerversion AIR 1.5
		 * @langversion 3.0
		 * @see flashx.textLayout.formats.ColorName
		 */
		 ...
		 * @playerversion AIR 1.5
		 * @langversion 3.0
		 * @see flashx.textLayout.formats.BorderColor
		 */
		 ...
		 * @playerversion AIR 1.5
		 * @langversion 3.0
		 * @see flashx.textLayout.formats.TableFrame
		 */
		 ...
		 * @playerversion AIR 1.5
		 * @langversion 3.0
		 * @see flashx.textLayout.formats.TableRules
		 */
